...
class ProdutosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create produto" do
    assert_difference('Produto.count') do
      post produtos_url, params: { produto: { codigo_de_barras: @produto.codigo_de_barras, estoque: @produto.estoque, nome: @produto.nome, valor: @produto.valor } }
    end
  ...
  test "should update produto" do
    patch produto_url(@produto), params: { produto: { codigo_de_barras: @produto.codigo_de_barras, estoque: @produto.estoque, nome: @produto.nome, valor: @produto.valor } }
